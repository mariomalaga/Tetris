...
namespace Tetris
{
	...
	public class Tetris
	{
		...
		private static int m_puntuacion;
		private int m_nivel;
		...
		public Tetris()
		{
            ...
            m_matrizPiezas[7] = new Pieza(formaPieza1, formaPieza1, formaPieza1, formaPieza1, 7);
            ...
            formaPieza4 += "0100";
            formaPieza4 += "0100";
            m_matrizPiezas[8] = new Pieza(formaPieza1, formaPieza2, formaPieza3, formaPieza4, 6);
        ...
        public static int Puntuacion { get => m_puntuacion; set => m_puntuacion = value; }
		...
		public void muevePiezaAbajo()
		{
			...
			else
			{
				...
				if (!m_matrizPantalla.puedeBajarPieza(m_piezaActual) && m_piezaActual.posY < 0)
				{
                    ...
                    gui.mniCambiarTamano.Enabled = true;
				}
		...
		public void inicializa()
		{
            ...
            gui.mniCambiarTamano.Enabled = false;
        }
